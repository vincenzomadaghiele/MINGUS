...
For next meeting:
    ...
    - how to generate dataset for evaluation (how many songs, how many notes...)?
"""
...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        #REMOVE
        batches_loss.append(np.array(losses))
        epoch_losses.append(val_loss)
        #REMOVE
    
    batches_loss = np.array(batches_loss)
    ...
    # REMOVE
    batches_loss = batches_loss.T
    epoch_losses = epoch_losses.T
    # convert array into dataframe 
    import pandas as pd
    DF_batches = pd.DataFrame(batches_loss) 
    DF_epochs = pd.DataFrame(epoch_losses) 
    
    # save the dataframe as a csv file 
    DF_batches.to_csv("batches_loss.csv")
    DF_epochs.to_csv("epoch_losses.csv")
    #REMOVE
