...
if __name__ == '__main__':
    ...
    savePATHpitch = 'modelsPitch/modelPitch_'+ str(epochs) + 'epochs_EURECOM_folkDB.pt'
    ...
    savePATHduration = 'modelsDuration/modelDuration_'+ str(epochs) + 'epochs_EURECOM_folkDB.pt'
