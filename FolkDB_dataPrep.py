...
if __name__=="__main__":
    ...
    path = 'data/folkDB/abc_files/data_v2_withtitles.abc'
    abcFiles = [path]
    songs = []
    for file in abcFiles:
        ...
        for abcSong in abcSongbook[0].values():
            ...
            if len(time_signatures) == 1 and len(tempos) <= 1 and time_signatures[0].numerator == 4 and time_signatures[0].denominator == 4 and chords_times:
    ...
    with open('data/folkDB.json', 'w') as fp:
